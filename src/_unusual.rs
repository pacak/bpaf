...
//!
//! While `bpaf` is designed with some common use cases in mind - mostly posix conventions
//! <https://pubs.opengroup.org/onlinepubs/9699919799.2018edition/basedefs/V1_chap12.html>

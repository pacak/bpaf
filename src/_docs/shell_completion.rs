...
//!    ````
//!
//! 1. Decorate [`argument`](SimpleParser::argument) and [`positional`](positional) parsers with
//!    [`Parser::complete`](Parser::complete) to provide completion functions for arguments
//!
...
//!       ````
//!
//! 1. Restart your shell. Regenerating scripts and restarting the shell is needed only on the
